...
export default {
  ...
  renameDialogDescription: 'Give this instance a new name. Its data and account stay intact.',
  renameDialogLabel: 'New instance name',
  ...
  toastRenamed: 'Instance renamed.',
  toastRenameFailed: 'Failed to rename instance.',
